...
# 設定項目（S&P 500用・緩和版）
# ==========================================
# 1日あたりの最低売買代金（5,000,000ドル ＝ 約500万ドル/日）
MIN_TRADING_VALUE_USD = 5_000_000
...
def get_sp500_tickers():
    ...
    try:
        ...
        print(f'S&P 500の取得に失敗しました: {e}')
        return []


def check_swing_signal(ticker_symbol: str):
    """テクニカル＋流動性＋過熱感の判定（米国株版）"""
    try:
        df = yf.download(
            ticker_symbol,
            period='1y',
